...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('auth/assets/css/loginstyles.css') }}">
    <title>Login</title>
    <style>
        .Section{
            background-image: url("{{asset('auth/assets/img/l.jpg')}}");
...
<script src="{{ asset('auth/assets/js/loginscripts.js') }}"></script>
</body>
