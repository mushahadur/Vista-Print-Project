...
<head>
    ...
    <link rel="stylesheet" href="{{asset('/')}}auth/assets/css/signupstyles.css">
    <title>SignUp</title>
    <style>
        .Section{
            background-image: url("{{asset('/')}}auth/assets/img/s.jpg");
...
<script src="{{asset('/')}}auth/assets/js/signupscripts.js"></script>
</body>
</html>
