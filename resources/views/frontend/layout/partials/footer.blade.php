                        ...
                        <div class="tiva-html col-lg-4 col-md-12 col-xs-12">
                            <div class="block">
                                <div class="block-content">
                                    <p class="logo-footer">
                                        <img src="{{ asset('/') }}frontend/img/logo.png" alt="img" height="80" width="90">
                                    </p>
                                ...
                                <div class="block-content">
                                    <div class="contact-us">
                                        ...
                                        <div class="content-contact address-contact">
                                            <p>South Monipur, Mirpur -2, Dhaka-1216</p>
                                        </div>
                                    </div>
                                    <div class="contact-us">
                                        <div class="title-content">
            ...
            <div class="container">
                <div class="row">
                    <div class="text-center col-lg-12 ">
                        <span>
							<a target="_blank" href="https://www.templateshub.net">Developed by ❤ Mushahedur</a>
                        </span>
                    </div>
                </div>
            </div>
